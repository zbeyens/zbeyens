...
> From rich-text to real-time: tools for AI apps.
> All my code is now written by Claude.
...
- 👻 **[jotai-x](https://github.com/udecode/jotai-x)** - Jotai store factory for a best-in-class DX
- 🐻 **[zustand-x](https://github.com/udecode/zustand-x)** - Zustand store factory for a best-in-class DX

## GitHub Activity

![GitHub Contribution Graph](https://ghchart.rshah.org/zbeyens)

## What I'm Doing

- **Building Plate** - The AI-native editor at [platejs.org](https://platejs.org)
- **Building Better Convex** - The DX layer Convex is missing at [better-convex.com](https://www.better-convex.com/)
...
> "Great DX compounds" - Every layer of abstraction should make the next developer's life easier. Build primitives, compose solutions.
